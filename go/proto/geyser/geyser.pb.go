...
import (
	geyserstorage "github.com/noncepad/solpipe-market/go/proto/geyserstorage"
...
type RewardType = geyserstorage.RewardType

const RewardType_Unspecified = geyserstorage.RewardType_Unspecified
const RewardType_Fee = geyserstorage.RewardType_Fee
const RewardType_Rent = geyserstorage.RewardType_Rent
const RewardType_Staking = geyserstorage.RewardType_Staking
const RewardType_Voting = geyserstorage.RewardType_Voting

var RewardType_name = geyserstorage.RewardType_name
var RewardType_value = geyserstorage.RewardType_value

type ConfirmedBlock = geyserstorage.ConfirmedBlock
type ConfirmedTransaction = geyserstorage.ConfirmedTransaction
type Transaction = geyserstorage.Transaction
type Message = geyserstorage.Message
type MessageHeader = geyserstorage.MessageHeader
type MessageAddressTableLookup = geyserstorage.MessageAddressTableLookup
type TransactionStatusMeta = geyserstorage.TransactionStatusMeta
type TransactionError = geyserstorage.TransactionError
type InnerInstructions = geyserstorage.InnerInstructions
type InnerInstruction = geyserstorage.InnerInstruction
type CompiledInstruction = geyserstorage.CompiledInstruction
type TokenBalance = geyserstorage.TokenBalance
type UiTokenAmount = geyserstorage.UiTokenAmount
type ReturnData = geyserstorage.ReturnData
type Reward = geyserstorage.Reward
type Rewards = geyserstorage.Rewards
type UnixTimestamp = geyserstorage.UnixTimestamp
type BlockHeight = geyserstorage.BlockHeight
...
type SubscribeUpdateTransactionInfo struct {
	...
	Transaction   *geyserstorage.Transaction           `protobuf:"bytes,3,opt,name=transaction,proto3" json:"transaction,omitempty"`
	Meta          *geyserstorage.TransactionStatusMeta `protobuf:"bytes,4,opt,name=meta,proto3" json:"meta,omitempty"`
...
func (x *SubscribeUpdateTransactionInfo) GetTransaction() *geyserstorage.Transaction {
	if x != nil {
		return x.Transaction
	}
	return nil
...
func (x *SubscribeUpdateTransactionInfo) GetMeta() *geyserstorage.TransactionStatusMeta {
	if x != nil {
		return x.Meta
	}
	return nil
...
type SubscribeUpdateBlock struct {
	...
	Rewards                  *geyserstorage.Rewards            `protobuf:"bytes,3,opt,name=rewards,proto3" json:"rewards,omitempty"`
	BlockTime                *geyserstorage.UnixTimestamp      `protobuf:"bytes,4,opt,name=block_time,json=blockTime,proto3" json:"block_time,omitempty"`
	BlockHeight              *geyserstorage.BlockHeight        `protobuf:"bytes,5,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
...
func (x *SubscribeUpdateBlock) GetRewards() *geyserstorage.Rewards {
	if x != nil {
		return x.Rewards
	}
	return nil
...
func (x *SubscribeUpdateBlock) GetBlockTime() *geyserstorage.UnixTimestamp {
	if x != nil {
		return x.BlockTime
	}
	return nil
...
func (x *SubscribeUpdateBlock) GetBlockHeight() *geyserstorage.BlockHeight {
	if x != nil {
...
func (x *SubscribeUpdateBlockMeta) GetRewards() *geyserstorage.Rewards {
	if x != nil {
		return x.Rewards
	}
	return nil
...
func (x *SubscribeUpdateBlockMeta) GetBlockTime() *geyserstorage.UnixTimestamp {
	if x != nil {
		return x.BlockTime
	}
	return nil
...
func (x *SubscribeUpdateBlockMeta) GetBlockHeight() *geyserstorage.BlockHeight {
	if x != nil {
		return x.BlockHeight
	}
	return nil
...
var file_geyser_proto_rawDesc = string([]byte{
	...
	0x67, 0x65, 0x79, 0x73, 0x65, 0x72, 0x50, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})
...
var file_geyser_proto_goTypes = []any{
	...
	(*geyserstorage.Transaction)(nil),                  // 41: solana.storage.ConfirmedBlock.Transaction
	(*geyserstorage.TransactionStatusMeta)(nil),        // 42: solana.storage.ConfirmedBlock.TransactionStatusMeta
	(*geyserstorage.Rewards)(nil),                      // 43: solana.storage.ConfirmedBlock.Rewards
	(*geyserstorage.UnixTimestamp)(nil),                // 44: solana.storage.ConfirmedBlock.UnixTimestamp
	(*geyserstorage.BlockHeight)(nil),                  // 45: solana.storage.ConfirmedBlock.BlockHeight
}

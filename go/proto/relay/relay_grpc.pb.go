...
type CapacityClient interface {
	OnStatus(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Capacity_OnStatusClient, error)
}
...
func (c *capacityClient) OnStatus(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Capacity_OnStatusClient, error) {
...
type CapacityServer interface {
	OnStatus(*Empty, Capacity_OnStatusServer) error
...
func (UnimplementedCapacityServer) OnStatus(*Empty, Capacity_OnStatusServer) error {
...
type MeterClient interface {
	...
	OnStatus(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Meter_OnStatusClient, error)
}
...
func (c *meterClient) OnStatus(ctx context.Context, in *Empty, opts ...grpc.CallOption) (Meter_OnStatusClient, error) {
...
type MeterServer interface {
	...
	OnStatus(*Empty, Meter_OnStatusServer) error
...
func (UnimplementedMeterServer) OnStatus(*Empty, Meter_OnStatusServer) error {
	return status.Errorf(codes.Unimplemented, "method OnStatus not implemented")
}

...
var file_solpipe_proto_rawDesc = []byte{
	...
	0x0c, 0x73, 0x6f, 0x6c, 0x70, 0x69, 0x70, 0x65, 0x73, 0x74, 0x61, 0x74, 0x65, 0x22, 0x47, 0x0a,
	...
	0x73, 0x6f, 0x6c, 0x70, 0x69, 0x70, 0x65, 0x2d, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x2f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x6f, 0x6c, 0x70, 0x69, 0x70, 0x65, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_solpipe_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_solpipe_proto_goTypes = []interface{}{
	(Commitment)(0),             // 0: solpipestate.Commitment
	(*SlotRequest)(nil),         // 1: solpipestate.SlotRequest
	(*SlotResponse)(nil),        // 2: solpipestate.SlotResponse
	(*TreeRequest)(nil),         // 3: solpipestate.TreeRequest
	(*TreeResponse)(nil),        // 4: solpipestate.TreeResponse
	(*SolRequest)(nil),          // 5: solpipestate.SolRequest
	(*SolResponse)(nil),         // 6: solpipestate.SolResponse
	(*TokenRequest)(nil),        // 7: solpipestate.TokenRequest
	(*TokenById)(nil),           // 8: solpipestate.TokenById
	(*TokenByOwner)(nil),        // 9: solpipestate.TokenByOwner
	(*TokenByOwnerAndMint)(nil), // 10: solpipestate.TokenByOwnerAndMint
	(*TokenResponse)(nil),       // 11: solpipestate.TokenResponse
	(*TokenBalance)(nil),        // 12: solpipestate.TokenBalance
	(*StreamRequest)(nil),       // 13: solpipestate.StreamRequest
	(*StreamResponse)(nil),      // 14: solpipestate.StreamResponse
	(*NotificationFilter)(nil),  // 15: solpipestate.NotificationFilter
	(*SingleRequest)(nil),       // 16: solpipestate.SingleRequest
	(*NotificationRequest)(nil), // 17: solpipestate.NotificationRequest
	(*Notification)(nil),        // 18: solpipestate.Notification
	(*PayloadUpdate)(nil),       // 19: solpipestate.PayloadUpdate
	(*DeleteWithTxid)(nil),      // 20: solpipestate.DeleteWithTxid
	(*Node)(nil),                // 21: solpipestate.Node
	(*TreeNotFound)(nil),        // 22: solpipestate.TreeNotFound
}
var file_solpipe_proto_depIdxs = []int32{
	0,  // 0: solpipestate.SlotRequest.commitment:type_name -> solpipestate.Commitment
	8,  // 1: solpipestate.TokenRequest.by_id:type_name -> solpipestate.TokenById
	9,  // 2: solpipestate.TokenRequest.by_owner:type_name -> solpipestate.TokenByOwner
	10, // 3: solpipestate.TokenRequest.by_owner_and_mint:type_name -> solpipestate.TokenByOwnerAndMint
	12, // 4: solpipestate.TokenResponse.balance:type_name -> solpipestate.TokenBalance
	17, // 5: solpipestate.StreamRequest.notification_request:type_name -> solpipestate.NotificationRequest
	15, // 6: solpipestate.StreamRequest.filter:type_name -> solpipestate.NotificationFilter
	18, // 7: solpipestate.StreamResponse.notification:type_name -> solpipestate.Notification
	22, // 8: solpipestate.StreamResponse.tree:type_name -> solpipestate.TreeNotFound
	17, // 9: solpipestate.SingleRequest.notification_request:type_name -> solpipestate.NotificationRequest
	21, // 10: solpipestate.Notification.change:type_name -> solpipestate.Node
	20, // 11: solpipestate.Notification.delete:type_name -> solpipestate.DeleteWithTxid
	19, // 12: solpipestate.Notification.update:type_name -> solpipestate.PayloadUpdate
	16, // 13: solpipestate.Tree.Get:input_type -> solpipestate.SingleRequest
	3,  // 14: solpipestate.Tree.GetTreeByPubkey:input_type -> solpipestate.TreeRequest
	13, // 15: solpipestate.Tree.Stream:input_type -> solpipestate.StreamRequest
	5,  // 16: solpipestate.Tree.OnSol:input_type -> solpipestate.SolRequest
	7,  // 17: solpipestate.Tree.OnToken:input_type -> solpipestate.TokenRequest
	1,  // 18: solpipestate.Tree.OnSlot:input_type -> solpipestate.SlotRequest
	18, // 19: solpipestate.Tree.Get:output_type -> solpipestate.Notification
	4,  // 20: solpipestate.Tree.GetTreeByPubkey:output_type -> solpipestate.TreeResponse
	14, // 21: solpipestate.Tree.Stream:output_type -> solpipestate.StreamResponse
	6,  // 22: solpipestate.Tree.OnSol:output_type -> solpipestate.SolResponse
	11, // 23: solpipestate.Tree.OnToken:output_type -> solpipestate.TokenResponse
	2,  // 24: solpipestate.Tree.OnSlot:output_type -> solpipestate.SlotResponse
...
func file_solpipe_proto_init() {
	...
	file_solpipe_proto_msgTypes[12].OneofWrappers = []interface{}{
